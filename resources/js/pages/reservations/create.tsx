...
export default function CreateReservation({
    ...
    next_order_num: nextOrderNumber,
    settings,
}: Props) {
    ...
    const generateInvoicePreview = async (
        ...
        const documentLabel = invoiceDocumentLabel(documentType);
        const invoiceDate = formatDocumentDate(
    ...
    const generateInstallmentInvoicePreview = async (
        ...
        const invoiceNumber = isAdvanceInvoice
            ? buildInvoiceNumber(nextOrderNumber, invoiceYear, `-AFR${installmentIndex + 1}`)
            : buildInvoiceNumber(nextOrderNumber, invoiceYear, `-R${installmentIndex + 1}`);
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Dodajte rezervaciju" />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Jedna rezervacija može sadržavati više klijenata sa
                            paketima.
                        </p>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="inline-flex items-center">
                            <Button
                                ...
                                onClick={() =>
                                    generateInvoicePreview('predracun')
                                }
                            >
                                Generišite (pred)račun
                            </Button>
                            <DropdownMenu>
