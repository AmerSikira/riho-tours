...
export default function CreateSupplier() {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Dodajte dobavljača',
            href: '/dobavljaci/dodaj',
        },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Dodajte dobavljača" />

            <div className="flex h-full w-full max-w-6xl flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 mx-auto">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-xl font-semibold">Dodajte dobavljača</h1>
                        <p className="text-sm text-muted-foreground">
                            Unesite osnovne poslovne podatke dobavljača.
                        </p>
                    </div>
